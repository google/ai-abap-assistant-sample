...
**********************************************************************
CLASS zclca_abap_assist_adt_res_cont DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF gc_adt,
        class_name    TYPE seoclsname VALUE 'ZCLCA_ABAP_ASSIST_ADT_RES_CONT',
...
CLASS ZCLCA_ABAP_ASSIST_ADT_RES_CONT IMPLEMENTATION.
